...
export const fiveDaysSplit: TrainingWeeklySplit = {
  push: {
    ...
    exercisesDescriptions: [
      ...
      "High or moderate intensity Chest Exercise, with a inclined angle - 3 Series",
      "Any Other Chest Exercise with Moderate or Low intensity - 3 series",
      "Any Shoulders Exercise with Frontal movement - 3 Series",
