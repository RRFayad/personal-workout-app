/*
  ...
  - You are about to drop the column `createdAt` on the `user_auth_info` table. All the data in the column will be lost.
  - You are about to drop the column `emailVerified` on the `user_auth_info` table. All the data in the column will be lost.
  - You are about to drop the column `updatedAt` on the `user_auth_info` table. All the data in the column will be lost.
  ...
  - Added the required column `updated_at` to the `user_auth_info` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "user_auth_info" DROP COLUMN "createdAt",
...
-- AddForeignKey
ALTER TABLE "Account" ADD CONSTRAINT "Account_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user_auth_info"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Session" ADD CONSTRAINT "Session_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user_auth_info"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Authenticator" ADD CONSTRAINT "Authenticator_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user_auth_info"("id") ON DELETE CASCADE ON UPDATE CASCADE;
