/*
  ...
  - You are about to drop the `user_auth_info` table. If the table is not empty, all the data it contains will be lost.
...
-- AddForeignKey
ALTER TABLE "workout_program_structure" ADD CONSTRAINT "workout_program_structure_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "nutrition_program" ADD CONSTRAINT "nutrition_program_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
